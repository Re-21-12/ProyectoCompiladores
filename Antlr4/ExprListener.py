...
class ExprListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by ExprParser#bloque_for.
    def enterBloque_for(self, ctx:ExprParser.Bloque_forContext):
        pass

    # Exit a parse tree produced by ExprParser#bloque_for.
    def exitBloque_for(self, ctx:ExprParser.Bloque_forContext):
        pass
